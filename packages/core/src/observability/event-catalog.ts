...
export const EVENT_CATALOG: readonly EventCatalogEntry[] = [
  ...
  {
    event_name: "handle_named_plan_request.start",
    category: "conversation",
    required_fields: ["route", "session_mode", "session_state_token"],
    optional_fields: ["correlation_id", "contactName", "messageLength"],
    pii_fields: [],
  },
  {
    event_name: "handle_named_plan_request.eligibility",
    category: "conversation",
    required_fields: ["route", "session_mode", "session_state_token"],
    optional_fields: ["correlation_id", "eligible"],
    pii_fields: [],
  },
  {
    event_name: "handle_named_plan_request.contact_resolved",
    category: "conversation",
    required_fields: ["route", "session_mode", "session_state_token"],
    optional_fields: ["correlation_id", "contactId"],
    pii_fields: [],
  },
  {
    event_name: "handle_named_plan_request.plan_brief_created",
    category: "conversation",
    required_fields: ["route", "session_mode", "session_state_token"],
    optional_fields: ["correlation_id", "planBriefId"],
    pii_fields: [],
  },
  {
    event_name: "handle_named_plan_request.contact_not_found",
    category: "conversation",
    required_fields: ["route", "session_mode", "session_state_token"],
    optional_fields: ["correlation_id", "contactName"],
    pii_fields: [],
  },
  {
    event_name: "handle_post_activity_checkin.start",
    category: "conversation",
    required_fields: ["route", "session_mode", "session_state_token"],
    optional_fields: ["correlation_id", "step", "planBriefId"],
    pii_fields: [],
  },
  {
    event_name: "handle_post_activity_checkin.signal_written",
    category: "conversation",
    required_fields: ["route", "session_mode", "session_state_token"],
    optional_fields: ["correlation_id", "signalType"],
    pii_fields: [],
  },
  {
    event_name: "handle_post_activity_checkin.session_idle",
    category: "conversation",
    required_fields: ["route", "session_mode", "session_state_token"],
    optional_fields: ["correlation_id", "finalStep"],
    pii_fields: [],
  },
  {
    event_name: "handle_post_activity_checkin.ambiguous_parse",
    category: "conversation",
    required_fields: ["route", "session_mode", "session_state_token"],
    optional_fields: ["correlation_id", "step", "message"],
    pii_fields: [],
  },
  {
    event_name: "handle_post_activity_checkin.duplicate_signal",
    category: "conversation",
    required_fields: ["route", "session_mode", "session_state_token"],
    optional_fields: ["correlation_id", "signalType", "idempotencyKey"],
    pii_fields: [],
  },
  {
    event_name: "handle_post_activity_checkin.missing_plan_brief_id",
    category: "conversation",
    required_fields: ["route", "session_mode", "session_state_token"],
    optional_fields: ["correlation_id", "stateToken"],
    pii_fields: [],
  },
  {
    event_name: "handle_post_activity_checkin.plan_brief_not_found",
    category: "conversation",
    required_fields: ["route", "session_mode", "session_state_token"],
    optional_fields: ["correlation_id", "planBriefId"],
    pii_fields: [],
  ...
  {
    event_name: "handle_post_activity_checkin.unknown_step",
    category: "conversation",
    required_fields: ["route", "session_mode", "session_state_token"],
    optional_fields: ["correlation_id", "stateToken"],
    pii_fields: [],
  ...
  {
    event_name: "generator_run.lock_unavailable",
    category: "system",
    required_fields: ["regionId"],
    optional_fields: [],
    pii_fields: [],
  },
  {
    event_name: "generator_run.complete",
    category: "system",
    required_fields: [
      "regionId",
      "eligibleUserCount",
      "clustersFormed",
      "clusterMembersDispatched",
      "soloInvitationsDispatched",
      "groupInvitationsDispatched",
      "skippedQuietHours",
      "skippedActivityUnresolvable",
      "skippedTimeWindowUnresolvable",
      "errors",
      "durationMs",
    ],
    optional_fields: [],
